...
<%
    ...
    if (strSQL_case02 != "") filtros = filtros + " " + strSQL_case022;
    ...
    if (strSQL_case011 != "") strSQL_case00 = strSQL_case011;

    if (strSQL_case022 != "") strSQL_case00 = strSQL_case022;
    ...
    try{
        ...
        if (rs.last()) {
            ...
            String avance2 = EW_FormatNumber(String.valueOf(avance),0,0,0,0,locale);
