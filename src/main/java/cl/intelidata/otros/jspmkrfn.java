...
public class jspmkrfn {
	...
	public static String Join(String[] aryString){
		String str = "";
	...
	public static boolean IsDate(String s, String dateFormat, Locale locale){
	...
	public static String EW_FormatDateTime(Object ADate, int ANamedFormat,Locale locale){
		...
		try{
			...
			case 7:
				...
				break;
			case 8:
				formatter = new SimpleDateFormat("dd/MM/yyyy H:k:ss", locale);
				output = formatter.format(ts);
				break;
			default:
	...
	public static java.sql.Timestamp EW_UnFormatDateTime(String ADate,String dateFormat, Locale locale){
	...
	public static String EW_FormatCurrency(Object obj, int numDigitsAfterDecimal, int includeLeadingDigit,
	...
	public static String EW_FormatNumber(Object obj, int numDigitsAfterDecimal, int includeLeadingDigit,
															int useParensForNegativeNumbers, int groupDigits, Locale locale){
		double value = 0;
		try {
			value = Double.parseDouble((String)obj);
	...
	public static String EW_FormatPercent(Object obj, int numDigitsAfterDecimal, int includeLeadingDigit,
															int useParensForNegativeNumbers, int groupDigits, Locale locale){
		double value = 0;
		try {
			value = Double.parseDouble((String)obj);
	...
	public static String EW_GetFileType(String contentType)
	{
	...
	public static String Limpia_String(String param)
	{
		...
		param = param.replace("ñ","n");
//		param = param.replace(".","_");
//		param = param.replace(" ","_");
		return param;
	}

	public static String Limpia_String_Fac(String param)
	{
		param = param.replace("á","a");
		param = param.replace("é","e");
		param = param.replace("í","i");
	...
	public static String RecortaNombre(String param)
	{
		param = param.replace("Facultad ","Fac. ");
		param = param.replace("Instituto ","Inst. ");
		return param;
	}
}
